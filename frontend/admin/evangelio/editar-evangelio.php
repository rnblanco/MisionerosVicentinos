<?php
    ...
    class EditarEvangelio extends DB{
		...
		public function Cargar(){
			...
			$buscarPublicacion = $conexion->prepare("SELECT * FROM evangelio WHERE Id = ? ");
			$buscarPublicacion->execute([$id]);
			$Publicacion = $buscarPublicacion->fetchAll();

			foreach($Publicacion as list($idHistorial, $texto, $pais)){
	...
	else require_once 'editar-evangelio.view.php';
?>