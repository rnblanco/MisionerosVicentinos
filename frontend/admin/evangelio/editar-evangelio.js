...
$(document).ready(function(){
        ...
        $(".next").click(function(e){
            ...
            if( validate1(1) && validate1(2) && validate1(4)){
                        ...
                        form_data.append("texto", texto);form_data.append("titulo", pais);form_data.append("id",id);
                        $.ajax({
                            url:'../../../backend/evangelio/editar-evangelio.php',
                            data:form_data,
                            cache: false,
                            contentType: false,
                            processData: false,
                            type:'post',
                            success:function(){
                                Swal.fire('Evangelio editado correctamente! ','','success').then((result)=>{
                                    if(result.value){
                                        location.reload(true);
                                    }
                                });           
                            }, error:function(){
                                Swal.fire('No has hecho cambios en el evangelio','','error');
                            }   
                        });   
            }
