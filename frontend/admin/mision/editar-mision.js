            ...
            if( validate1(2) && validate1(3) && validate1(4)){
                ...
                if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                    ...
                    if(fsize > 2000000){
                        ...
                        $.ajax({
                            url:'../../../backend/mision/editar-mision.php',
                            data:form_data,
                            cache: false,
                            contentType: false,
                            processData: false,
                            type:'post',
                            success:function(){
                                Swal.fire('Misión editada correctamente! ','','success').then((result)=>{
                                    if(result.value){
                                        location.reload(true);
                                    }
                                });           
                            }, error:function(){
                                Swal.fire('La misión no fue editada','','error');
                            }   
                        });   
                    }
                }
                ...
                var form_data = new FormData();
                        ...
                        $.ajax({
                            ...
                            success:function(){
                                ...
                                Swal.fire('No has hecho cambios en la misión','','error');
                            }   
                        });   
            }
            else{
