...
$(document).ready(function(e){
    $(".next").click(function(e){
        ...
        if(validate1(1) == true && validate1(2) == true && validate1(3) == true){
            ...
            if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                ...
                if(fsize > 2000000){
                    ...
                    form_data.append("historia", texto);form_data.append("nombre", pais);
                    $.ajax({
                        url:'../../../../backend/santoral/agregar-santoral.php',
                        data:form_data,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success:function(data){
                            if(data.code = 200){
                                   Swal.fire('Santo agregado de manera exitosa! ','','success').then((result)=>{
                                    if(result.value){
                                        window.location.href = "../santoral.php";
                                    }
                                })
                            }
                            else{
                                Swal.fire('El Santo no pudo ser agregado, intenta de nuevo','','error');
                            }
                        }
