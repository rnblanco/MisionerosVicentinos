...
<html lang="es">
    ...
    <body id="page-top">
              ...
              <div class="container-fluid px-1 mx-auto">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-10 col-lg-11 col-md-12">
                        <div class="card b-0">
                            <h4 class="heading">Agregar un santo</h4>
                            <form  method="post" enctype="multipart/form-data" id="form">
                                <div class="form-card">
                                  ...
                                  <div class='form-group'> <label class='form-control-label'>Nombre:</label> <input onkeypress='javascript:return tprotection(event)'' type='text' id='pais' class='form-control' onblur='validate1(1)'></div>
                                  <div class='form-group'> <label class='form-control-label'>Historia:</label> <textarea onkeypress='javascript:return bprotection(event)'' type='text' id='texto' class='form-control' onblur='validate1(2)'></textarea></div>
      ...
      <script src="agregar-santoral.js"></script>
