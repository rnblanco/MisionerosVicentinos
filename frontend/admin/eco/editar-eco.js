...
$(document).ready(function(){
    ...
    $(".next").click(function(e){
        ...
        //con imagen
        if( validate1(2) && validate1(3) && validate1(4)){
            ...
            if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                ...
                if(fsize > 2000000){
                    ...
                    form_data.append("texto", texto);form_data.append("id",id);
                    $.ajax({
                        url:'../../../backend/eco/editar-eco.php',
                        data:form_data,
                        cache: false,
                        contentType: false,
                        processData: false,
                        type:'post',
                        success:function(){
                            Swal.fire('Eco editado correctamente! ','','success').then((result)=>{
                                if(result.value){
                                    window.location.href = "editar-eco.php?id=1";
                                }
                            });
                        }, error:function(){
                            Swal.fire('El eco no fue editado','','error');
                        }
                    });
                }
            }
        ...
        //sin imagen
        else if( validate1(2) && validate1(3)==false && validate1(4)){
            ...
            var form_data = new FormData();
                    ...
                    $.ajax({
                        ...
                        success:function(){
                            ...
                            Swal.fire('No has hecho cambios en el eco','','error');
                        }
                    });
        }
        else{
