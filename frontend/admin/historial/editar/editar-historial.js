            ...
            if( validate1(1) && validate1(2) && validate1(3) && validate1(4)){
                ...
                if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                    ...
                    if(fsize > 2000000){
                        ...
                        form_data.append("texto", texto);form_data.append("pais", pais);form_data.append("id",id);      
                        $.ajax({
                            url:'../../../../backend/historial/editar-historial.php',
                            data:form_data,
                            cache: false,
                            contentType: false,
                            processData: false,
                            type:'post',
                            success:function(){
                                Swal.fire('Historial editado correctamente! ','','success').then((result)=>{
                                    if(result.value){
                                        window.location.href = "../historial.php";
                                    }
                                });           
                            }, error:function(){
                                Swal.fire('El historial no fue editado con imagen','','error');
                            }   
                        });   
                    }
                }
                ...
                var form_data = new FormData();
                        ...
                        $.ajax({
                            ...
                            success:function(){
                                ...
                                Swal.fire('No has hecho cambios en el historial','','error');
                            }   
                        });   
            }
            else{
