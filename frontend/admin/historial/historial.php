	...
	*/
    ...
    class Historial extends DB{
	    ...
	    public function Escritores(){
		    ...
		    $buscarEscritores = $conexion->prepare("SELECT * FROM historial ORDER BY Id_Historial");
		    ...
		    foreach($Escritores as list($id, $pais, $texto, $imagen)){
                ...
                <tr>
                    ...
                    <td>$pais</td>
                    <td>$texto</td>
                    <td><img class='card-img-top' src='../../../backend/images/countries-images/$imagen' alt='Card image cap' style='height:150px!important;width:200px!important;'></td>            
                    <td>
                        <a href='editar/editar-historial.php?id=$id' class='btn btn-warning btn-icon-split btn-block'><span class='icon text-white-50'><i class='fas fa-edit'></i></span><span class='text'>Editar</span></a><div class='my-2'></div>
	...
	else require_once 'historial.view.php';
?>