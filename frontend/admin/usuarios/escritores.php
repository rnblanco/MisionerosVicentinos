<?php
    ...
    */
	...
	class Escritores extends DB{

		public function Escri(){
			$ids = $_SESSION['id'];
			$stipo = $_SESSION['tipo'];
			$conexion = $this->conectar();
			$buscarEscritores = $conexion->prepare("SELECT * FROM usuarios WHERE Tipo = '1' ORDER BY Id_Usuario");
	...
	else require_once 'escritores.view.php';
?>