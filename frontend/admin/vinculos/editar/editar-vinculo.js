            ...
            if( validate1(1) && validate1(2) && validate1(3) && validate1(4)){
                ...
                if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                    ...
                    if(fsize > 2000000){
                        ...
                        form_data.append("enlace", texto);form_data.append("titulo", pais);form_data.append("id",id);
                        $.ajax({
                            url:'../../../../backend/vinculo/editar-vinculo.php',
                            data:form_data,
                            cache: false,
                            contentType: false,
                            processData: false,
                            ...
                            success:function(){
                                ...
                                Swal.fire('El Vínculo no fue editado con imagen','','error');
                            }   
                        });   
                    }
                }
                ...
                var form_data = new FormData();
                        ...
                        $.ajax({
                            ...
                            success:function(){
                                ...
                                Swal.fire('No has hecho cambios en el Vínculo','','error');
                            }   
                        });   
            }
            else{
