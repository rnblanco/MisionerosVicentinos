        ...
        if(validate1(1) == true && validate1(2) == true && validate1(3) == true){
            ...
            if(jQuery.inArray(ext, ['png','jpg','jpeg']) == -1){
                ...
                if(fsize > 2000000){
                    ...
                    form_data.append("enlace", texto);form_data.append("titulo", pais);
                    $.ajax({
                        url:'../../../../backend/vinculo/agregar-vinculo.php',
                        data:form_data,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success:function(data){
                            if(data.code = 200){
                                   Swal.fire('Vínculo agregado de manera exitosa! ','','success').then((result)=>{
                                    if(result.value){
                                ...
                                Swal.fire('El Vínculo no pudo ser agregado, intenta de nuevo','','error');
                            }
                        }
