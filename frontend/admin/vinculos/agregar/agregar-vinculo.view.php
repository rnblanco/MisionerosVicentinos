...
<body id="page-top">
          ...
          <div class="container-fluid px-1 mx-auto">
            <div class="row d-flex justify-content-center">
                <div class="col-xl-10 col-lg-11 col-md-12">
                    <div class="card b-0">
                        <h4 class="heading">Agregar un vínculo</h4>
                        <form method="post" enctype="multipart/form-data" id="form">
                            <div class="form-card">
                              ...
                              <div class='form-group'> <label class='form-control-label'>Enlace:</label> <input onkeypress='javascript:return bprotection(event)'' type='text' id='texto' class='form-control' onblur='validate1(2)'></div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script src="agregar-vinculo.js"></script>
