<?php
	...
	class EditarVision extends DB {
		...
		public function Cargar(){
			...
			$buscarPublicacion = $conexion->prepare("SELECT * FROM vision WHERE Id_vision = ? ");
			...
			foreach($Publicacion as list($idHistorial, $texto, $imagen)){
				...
				echo"
                    ...
                    <div class='form-group'> <label class='form-control-label'>Imagen * :</label> <br><img src='../../../backend/images/default-images/$imagen' id='preview' class='img-thumbnail' style='height:250px!important;width:300px!important;background-color:#1abc9c;'><br><div id='msg'></div><input type='file' name='img' id='img' class='file' accept='image/*' onblur='validate1(3)'><div class='input-group my-3'><input type='text' class='form-control' disabled placeholder='$imagen2[2]' id='file'><div class='input-group-append'><button type='button' class='browse btn btn-primary'>Subir</button></div></div></div> 
    ...
    if($usuario == null || $usuario = '') header("../../backend/auth/log-out.php");
    else require_once 'editar-vision.view.php';
?>