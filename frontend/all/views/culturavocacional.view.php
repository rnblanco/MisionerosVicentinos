    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column ">
                <h1 class="masthead-heading text-uppercase text-header">Cultura Vocacional</h1>
            </div>
        </header>

        <section class="page-section portfolio">
            <div class="container">
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Artículos</h2>
                ...
                <div class="row">
                    <?php $publicaciones->NoticiasInicio("Articulos Vocacionales"); ?>
                </div>
        ...
        <section class="page-section bg-primary text-white mb-0">
            <div class="container">
                <h2 class="page-section-heading text-center text-uppercase text-white">Seminarios</h2>
                ...
                <div class="row">
                    <?php $culturaVocacional->Seminarios(); ?>
                </div>
        ...
        <section class="page-section portfolio">
            <div class="container">
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Testimonios Vocacionales</h2>
                <div class="divider-custom"> <div class="divider-custom-line"></div> <div class="divider-custom-icon"><i class="fas fa-star"></i></div> <div class="divider-custom-line"></div> </div>
        ...
        <!-- Portfolio Modals-->
        <?php
            $publicaciones->VistaNoticiasInicio("Articulos Vocacionales");
            $publicaciones->VistaNoticiasInicio("Testimonios Vocacionales");
			$culturaVocacional->VerSeminarios();
        ?>
